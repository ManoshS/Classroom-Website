...
// Get All Classrooms
router.get('/classrooms', authenticateToken,authorizeRole(['teacher', 'principal']),classroomController.getClassrooms);

// Get Classroom by ID
router.get('/classrooms/:id',authenticateToken, authorizeRole(['teacher', 'principal']),classroomController.getClassroomById);
