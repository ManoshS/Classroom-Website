...
router.delete('/classroom-students', authenticateToken, authorizeRole(['teacher', 'principal']), classroomStudentController.removeStudentFromClassroom);

// Get all students in a classroom
router.get('/classroom-students/:classroom_id', authenticateToken, authorizeRole(['teacher', 'principal']), classroomStudentController.getStudentsByClassroomId);
